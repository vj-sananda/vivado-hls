...
void multi_counter(signed int *,  char ,  char , signed int , signed int *, bool *);


/* Global Variable Definitions and Initialization */
static  char aesl_internal__OC_str[14] = "CNT[%d] = %d\n";
...
signed int main(void) {
  ...
  bool llvm_cbe_valid;    /* Address-exposed local */
  static  unsigned long long aesl_llvm_cbe_CNT_count = 0;
  signed int llvm_cbe_CNT[256];    /* Address-exposed local */
...
printf("\n\{ BEGIN @main\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%0 = getelementptr inbounds [256 x i32]* %%CNT, i64 0, i64 0, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_40_count);
  llvm_cbe_tmp__1 = (signed int *)(&llvm_cbe_CNT[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 256
#endif
]);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 0, i3 zeroext 1, i32 0, i32* %%out, i1* %%valid) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_49_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )0), ((unsigned char )1), 0u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 1, i3 zeroext 1, i32 1, i32* %%out, i1* %%valid) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_85_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )1), ((unsigned char )1), 1u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )1));
printf("\nArgument  = 0x%X",((unsigned char )1));
printf("\nArgument  = 0x%X",1u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 2, i3 zeroext 1, i32 2, i32* %%out, i1* %%valid) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_121_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )2), ((unsigned char )1), 2u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 3, i3 zeroext 1, i32 3, i32* %%out, i1* %%valid) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_157_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )3), ((unsigned char )1), 3u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 4, i3 zeroext 1, i32 4, i32* %%out, i1* %%valid) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_193_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )4), ((unsigned char )1), 4u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 5, i3 zeroext 1, i32 5, i32* %%out, i1* %%valid) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_229_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )5), ((unsigned char )1), 5u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )5));
printf("\nArgument  = 0x%X",((unsigned char )1));
printf("\nArgument  = 0x%X",5u);
}
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 6, i3 zeroext 1, i32 6, i32* %%out, i1* %%valid) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_265_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )6), ((unsigned char )1), 6u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 7, i3 zeroext 1, i32 7, i32* %%out, i1* %%valid) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_301_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )7), ((unsigned char )1), 7u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 8, i3 zeroext 1, i32 8, i32* %%out, i1* %%valid) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_337_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )8), ((unsigned char )1), 8u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )8));
printf("\nArgument  = 0x%X",((unsigned char )1));
printf("\nArgument  = 0x%X",8u);
}
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 9, i3 zeroext 1, i32 9, i32* %%out, i1* %%valid) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_373_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )9), ((unsigned char )1), 9u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 0, i3 zeroext 2, i32 0, i32* %%out, i1* %%valid) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_435_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )0), ((unsigned char )2), 0u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )0));
printf("\nArgument  = 0x%X",((unsigned char )2));
printf("\nArgument  = 0x%X",0u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 1, i3 zeroext 2, i32 1, i32* %%out, i1* %%valid) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_471_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )1), ((unsigned char )2), 1u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )1));
printf("\nArgument  = 0x%X",((unsigned char )2));
printf("\nArgument  = 0x%X",1u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 2, i3 zeroext 2, i32 2, i32* %%out, i1* %%valid) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_507_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )2), ((unsigned char )2), 2u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )2));
printf("\nArgument  = 0x%X",((unsigned char )2));
printf("\nArgument  = 0x%X",2u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 3, i3 zeroext 2, i32 3, i32* %%out, i1* %%valid) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_543_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )3), ((unsigned char )2), 3u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )3));
printf("\nArgument  = 0x%X",((unsigned char )2));
printf("\nArgument  = 0x%X",3u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 4, i3 zeroext 2, i32 4, i32* %%out, i1* %%valid) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_579_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )4), ((unsigned char )2), 4u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )4));
printf("\nArgument  = 0x%X",((unsigned char )2));
printf("\nArgument  = 0x%X",4u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 5, i3 zeroext 2, i32 5, i32* %%out, i1* %%valid) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_615_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )5), ((unsigned char )2), 5u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )5));
printf("\nArgument  = 0x%X",((unsigned char )2));
printf("\nArgument  = 0x%X",5u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 6, i3 zeroext 2, i32 6, i32* %%out, i1* %%valid) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_651_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )6), ((unsigned char )2), 6u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )6));
printf("\nArgument  = 0x%X",((unsigned char )2));
printf("\nArgument  = 0x%X",6u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 7, i3 zeroext 2, i32 7, i32* %%out, i1* %%valid) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_687_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )7), ((unsigned char )2), 7u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )7));
printf("\nArgument  = 0x%X",((unsigned char )2));
printf("\nArgument  = 0x%X",7u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 8, i3 zeroext 2, i32 8, i32* %%out, i1* %%valid) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_723_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )8), ((unsigned char )2), 8u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )8));
printf("\nArgument  = 0x%X",((unsigned char )2));
printf("\nArgument  = 0x%X",8u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 9, i3 zeroext 2, i32 9, i32* %%out, i1* %%valid) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_759_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )9), ((unsigned char )2), 9u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )9));
printf("\nArgument  = 0x%X",((unsigned char )2));
printf("\nArgument  = 0x%X",9u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 0, i3 zeroext 3, i32 0, i32* %%out, i1* %%valid) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_848_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )0), ((unsigned char )3), 0u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )0));
printf("\nArgument  = 0x%X",((unsigned char )3));
printf("\nArgument  = 0x%X",0u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 1, i3 zeroext 3, i32 1, i32* %%out, i1* %%valid) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_884_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )1), ((unsigned char )3), 1u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )1));
printf("\nArgument  = 0x%X",((unsigned char )3));
printf("\nArgument  = 0x%X",1u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 2, i3 zeroext 3, i32 2, i32* %%out, i1* %%valid) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_920_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )2), ((unsigned char )3), 2u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )2));
printf("\nArgument  = 0x%X",((unsigned char )3));
printf("\nArgument  = 0x%X",2u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 3, i3 zeroext 3, i32 3, i32* %%out, i1* %%valid) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_956_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )3), ((unsigned char )3), 3u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )3));
printf("\nArgument  = 0x%X",((unsigned char )3));
printf("\nArgument  = 0x%X",3u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 4, i3 zeroext 3, i32 4, i32* %%out, i1* %%valid) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_992_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )4), ((unsigned char )3), 4u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )4));
printf("\nArgument  = 0x%X",((unsigned char )3));
printf("\nArgument  = 0x%X",4u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 5, i3 zeroext 3, i32 5, i32* %%out, i1* %%valid) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1028_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )5), ((unsigned char )3), 5u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )5));
printf("\nArgument  = 0x%X",((unsigned char )3));
printf("\nArgument  = 0x%X",5u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 6, i3 zeroext 3, i32 6, i32* %%out, i1* %%valid) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1064_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )6), ((unsigned char )3), 6u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )6));
printf("\nArgument  = 0x%X",((unsigned char )3));
printf("\nArgument  = 0x%X",6u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 7, i3 zeroext 3, i32 7, i32* %%out, i1* %%valid) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1100_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )7), ((unsigned char )3), 7u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )7));
printf("\nArgument  = 0x%X",((unsigned char )3));
printf("\nArgument  = 0x%X",7u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 8, i3 zeroext 3, i32 8, i32* %%out, i1* %%valid) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1136_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )8), ((unsigned char )3), 8u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )8));
printf("\nArgument  = 0x%X",((unsigned char )3));
printf("\nArgument  = 0x%X",8u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 9, i3 zeroext 3, i32 9, i32* %%out, i1* %%valid) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1172_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )9), ((unsigned char )3), 9u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )9));
printf("\nArgument  = 0x%X",((unsigned char )3));
printf("\nArgument  = 0x%X",9u);
...
llvm_cbe_tmp__17:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge212 = phi i32 [ 0, %%.preheader13 ], [ %%7, %%1  for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge212_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = trunc i32 %%storemerge212 to i8, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1227_count);
  llvm_cbe_tmp__2 = (unsigned char )((unsigned char )llvm_cbe_storemerge212&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__2);
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext %%2, i3 zeroext -4, i32 %%storemerge212, i32* %%out, i1* %%valid) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1228_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, llvm_cbe_tmp__2, ((unsigned char )4u), llvm_cbe_storemerge212, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",llvm_cbe_tmp__2);
printf("\nArgument  = 0x%X",((unsigned char )4u));
printf("\nArgument storemerge212 = 0x%X",llvm_cbe_storemerge212);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = sext i32 %%storemerge212 to i64, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1229_count);
  llvm_cbe_tmp__3 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge212);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = getelementptr inbounds [256 x i32]* %%CNT, i64 0, i64 %%3, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1230_count);
  llvm_cbe_tmp__4 = (signed int *)(&llvm_cbe_CNT[(((signed long long )llvm_cbe_tmp__3))
#ifdef AESL_BC_SIM
 % 256
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )llvm_cbe_tmp__3) < 256)) fprintf(stderr, "%s:%d: warning: Read access out of array 'CNT' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = load i32* %%4, align 4, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1231_count);
  llvm_cbe_tmp__5 = (unsigned int )*llvm_cbe_tmp__4;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @aesl_internal_.str, i64 0, i64 0), i32 %%storemerge212, i32 %%5) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1232_count);
  printf(( char *)((&aesl_internal__OC_str[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 14
#endif
])), llvm_cbe_storemerge212, llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE) {
printf("\nArgument storemerge212 = 0x%X",llvm_cbe_storemerge212);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = add nsw i32 %%storemerge212, 1, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1233_count);
  llvm_cbe_tmp__7 = (unsigned int )((unsigned int )(llvm_cbe_storemerge212&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__7&4294967295ull)));
  if (((llvm_cbe_tmp__7&4294967295U) == (10u&4294967295U))) {
    goto llvm_cbe__2e_preheader9;
  } else {
    llvm_cbe_storemerge212__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__7;   /* for PHI node */
    goto llvm_cbe_tmp__17;
  }
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 1, i3 zeroext 2, i32 9, i32* %%out, i1* %%valid) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1262_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )1), ((unsigned char )2), 9u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )1));
printf("\nArgument  = 0x%X",((unsigned char )2));
printf("\nArgument  = 0x%X",9u);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext 1, i3 zeroext -4, i32 9, i32* %%out, i1* %%valid) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1542_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, ((unsigned char )1), ((unsigned char )4u), 9u, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )1));
printf("\nArgument  = 0x%X",((unsigned char )4u));
printf("\nArgument  = 0x%X",9u);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = getelementptr inbounds [256 x i32]* %%CNT, i64 0, i64 1, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1543_count);
  llvm_cbe_tmp__8 = (signed int *)(&llvm_cbe_CNT[(((signed long long )1ull))
#ifdef AESL_BC_SIM
 % 256
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )1ull) < 256)) fprintf(stderr, "%s:%d: warning: Read access out of array 'CNT' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = load i32* %%8, align 4, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1544_count);
  llvm_cbe_tmp__9 = (unsigned int )*llvm_cbe_tmp__8;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @aesl_internal_.str, i64 0, i64 0), i32 1, i32 %%9) nounwind, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1545_count);
  printf(( char *)((&aesl_internal__OC_str[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 14
#endif
...
llvm_cbe_tmp__18:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge48 = phi i32 [ 0, %%.preheader9 ], [ %%17, %%11  for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge48_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = trunc i32 %%storemerge48 to i8, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1547_count);
  llvm_cbe_tmp__11 = (unsigned char )((unsigned char )llvm_cbe_storemerge48&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__11);
if (AESL_DEBUG_TRACE)
printf("\n  call void @multi_counter(i32* %%0, i8 signext %%12, i3 zeroext -4, i32 %%storemerge48, i32* %%out, i1* %%valid) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1548_count);
  multi_counter((signed int *)llvm_cbe_tmp__1, llvm_cbe_tmp__11, ((unsigned char )4u), llvm_cbe_storemerge48, (signed int *)(&llvm_cbe_out), (bool *)(&llvm_cbe_valid));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",llvm_cbe_tmp__11);
printf("\nArgument  = 0x%X",((unsigned char )4u));
printf("\nArgument storemerge48 = 0x%X",llvm_cbe_storemerge48);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = sext i32 %%storemerge48 to i64, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1549_count);
  llvm_cbe_tmp__12 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge48);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = getelementptr inbounds [256 x i32]* %%CNT, i64 0, i64 %%13, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1550_count);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )llvm_cbe_tmp__12) < 256)) fprintf(stderr, "%s:%d: warning: Read access out of array 'CNT' bound?\n", __FILE__, __LINE__);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @aesl_internal_.str, i64 0, i64 0), i32 %%storemerge48, i32 %%15) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1552_count);
  printf(( char *)((&aesl_internal__OC_str[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 14
#endif
])), llvm_cbe_storemerge48, llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE) {
printf("\nArgument storemerge48 = 0x%X",llvm_cbe_storemerge48);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = add nsw i32 %%storemerge48, 1, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1553_count);
  llvm_cbe_tmp__16 = (unsigned int )((unsigned int )(llvm_cbe_storemerge48&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__16&4294967295ull)));
  if (((llvm_cbe_tmp__16&4294967295U) == (10u&4294967295U))) {
    goto llvm_cbe__2e_preheader;
  } else {
    llvm_cbe_storemerge48__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__16;   /* for PHI node */
    goto llvm_cbe_tmp__18;
  }
