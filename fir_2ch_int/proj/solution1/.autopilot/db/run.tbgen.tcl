...
set C_modelArgList {
	...
	{ out_V int 40 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_V", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "out_V", "interface" : "fifo", "bitwidth" : 40, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ out_V_din sc_out sc_lv 40 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":40, "type": "signal", "bundle":{"name": "out_V", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	out_V { ap_fifo {  { out_V_din fifo_data 1 40 }  { out_V_full_n fifo_status 0 1 }  { out_V_write fifo_update 1 1 } } }
}
