...
struct dummy_fe : public sc_module {
    ...
    sc_signal< sc_logic > din_i_V_blk_n;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_lv<1> > tmp_fu_65_p2;
    sc_signal< sc_logic > din_q_V_blk_n;
    sc_signal< sc_logic > out_V_blk_n;
    sc_signal< sc_logic > ap_CS_fsm_state3;
    sc_signal< sc_lv<12> > i_2_fu_71_p2;
    sc_signal< sc_lv<12> > i_2_reg_80;
    sc_signal< bool > ap_block_state2;
    sc_signal< sc_lv<16> > din_q_V_read_reg_85;
    sc_signal< sc_lv<12> > i_reg_54;
    ...
    void thread_din_i_V_blk_n();
    void thread_din_i_V_read();
    void thread_din_q_V_blk_n();
    void thread_din_q_V_read();
    void thread_i_2_fu_71_p2();
