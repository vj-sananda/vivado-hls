...
architecture behav of fir_top is 
    ...
    "fir_top,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z030sbv485-3,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=3.500000,HLS_SYN_LAT=5003,HLS_SYN_TPT=5002,HLS_SYN_MEM=0,HLS_SYN_DSP=48,HLS_SYN_FF=364,HLS_SYN_LUT=602}";
    ...
    signal p_fir_2ch_int_cpp_li_U0_ap_start : STD_LOGIC := '0';
    signal p_fir_2ch_int_cpp_li_U0_ap_done : STD_LOGIC;
    signal p_fir_2ch_int_cpp_li_U0_ap_continue : STD_LOGIC;
    signal p_fir_2ch_int_cpp_li_U0_ap_idle : STD_LOGIC;
    signal p_fir_2ch_int_cpp_li_U0_ap_ready : STD_LOGIC;
    signal p_fir_2ch_int_cpp_li_U0_fir_in_read : STD_LOGIC;
    signal p_fir_2ch_int_cpp_li_U0_fir_out_din : STD_LOGIC_VECTOR (39 downto 0);
    signal p_fir_2ch_int_cpp_li_U0_fir_out_write : STD_LOGIC;
    ...
    component p_fir_2ch_int_cpp_li IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    ...
    p_fir_2ch_int_cpp_li_U0 : component p_fir_2ch_int_cpp_li
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    p_fir_2ch_int_cpp_li_U0_ap_start_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
    ...
    ap_done <= dummy_be_U0_ap_done;
    ap_idle <= (p_fir_2ch_int_cpp_li_U0_ap_idle and dummy_fe_U0_ap_idle and dummy_be_U0_ap_idle);
    ap_ready <= dummy_fe_U0_ap_ready;
