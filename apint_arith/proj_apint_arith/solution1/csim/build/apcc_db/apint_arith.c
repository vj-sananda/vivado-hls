...
if (AESL_DEBUG_TRACE)
printf("\n  store i18 %%3, i18* %%out1, align 4, !dbg !4 for 0x%I64xth hint within @apint_arith  --> \n", ++aesl_llvm_cbe_24_count);
