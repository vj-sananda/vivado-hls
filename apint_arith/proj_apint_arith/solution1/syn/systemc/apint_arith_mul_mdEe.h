...
#ifndef __apint_arith_mul_mdEe__HH__
#define __apint_arith_mul_mdEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(apint_arith_mul_mdEe) {
    ...
    SC_CTOR(apint_arith_mul_mdEe):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
