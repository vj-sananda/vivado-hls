; ModuleID = 'C:/Users/vsananda/work/apint_arith/proj_apint_arith/solution1/.autopilot/db/a.g.1.bc'
...
define void @apint_arith(i6 signext %inA, i12 signext %inB, i22 signext %inC, i33 %inD, i18* %out1, i13* %out2, i22* %out3, i6* %out4) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i6 %inA}, i64 0, metadata !42), !dbg !43 ; [debug line = 94:25] [debug variable = inA]
  call void @llvm.dbg.value(metadata !{i12 %inB}, i64 0, metadata !44), !dbg !45 ; [debug line = 94:37] [debug variable = inB]
  call void @llvm.dbg.value(metadata !{i22 %inC}, i64 0, metadata !46), !dbg !47 ; [debug line = 94:49] [debug variable = inC]
  call void @llvm.dbg.value(metadata !{i33 %inD}, i64 0, metadata !48), !dbg !49 ; [debug line = 94:61] [debug variable = inD]
  call void @llvm.dbg.value(metadata !{i18* %out1}, i64 0, metadata !50), !dbg !51 ; [debug line = 95:21] [debug variable = out1]
  call void @llvm.dbg.value(metadata !{i13* %out2}, i64 0, metadata !52), !dbg !53 ; [debug line = 95:36] [debug variable = out2]
  call void @llvm.dbg.value(metadata !{i22* %out3}, i64 0, metadata !54), !dbg !55 ; [debug line = 95:51] [debug variable = out3]
  call void @llvm.dbg.value(metadata !{i6* %out4}, i64 0, metadata !56), !dbg !57 ; [debug line = 95:66] [debug variable = out4]
  %tmp = sext i6 %inA to i18, !dbg !58            ; [#uses=1 type=i18] [debug line = 99:2]
  %tmp.1 = sext i12 %inB to i18, !dbg !58         ; [#uses=1 type=i18] [debug line = 99:2]
  %tmp.2 = mul i18 %tmp.1, %tmp, !dbg !58         ; [#uses=1 type=i18] [debug line = 99:2]
  store i18 %tmp.2, i18* %out1, align 4, !dbg !58 ; [debug line = 99:2]
  %tmp.3 = sext i12 %inB to i13, !dbg !60         ; [#uses=1 type=i13] [debug line = 100:2]
  %tmp.4 = sext i6 %inA to i13, !dbg !60          ; [#uses=1 type=i13] [debug line = 100:2]
  %tmp.5 = add i13 %tmp.3, %tmp.4, !dbg !60       ; [#uses=1 type=i13] [debug line = 100:2]
  store i13 %tmp.5, i13* %out2, align 2, !dbg !60 ; [debug line = 100:2]
  %tmp.6 = sext i22 %inC to i32, !dbg !61         ; [#uses=1 type=i32] [debug line = 101:2]
  %tmp.7 = sext i6 %inA to i32, !dbg !61          ; [#uses=1 type=i32] [debug line = 101:2]
  %tmp.8 = sdiv i32 %tmp.6, %tmp.7, !dbg !61      ; [#uses=1 type=i32] [debug line = 101:2]
  %tmp.9 = trunc i32 %tmp.8 to i22, !dbg !61      ; [#uses=1 type=i22] [debug line = 101:2]
  store i22 %tmp.9, i22* %out3, align 4, !dbg !61 ; [debug line = 101:2]
  %tmp.10 = sext i6 %inA to i33, !dbg !62         ; [#uses=1 type=i33] [debug line = 102:2]
  %tmp.11 = srem i33 %inD, %tmp.10, !dbg !62      ; [#uses=1 type=i33] [debug line = 102:2]
  %tmp.12 = trunc i33 %tmp.11 to i6, !dbg !62     ; [#uses=1 type=i6] [debug line = 102:2]
  store i6 %tmp.12, i6* %out4, align 1, !dbg !62  ; [debug line = 102:2]
