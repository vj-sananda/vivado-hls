...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "apint_arith.autotvin.dat"
	set constFileTvOut       "apint_arith.autotvout.dat"
	set constFileHdlTvIn     "apint_arith.autohdltvin.dat"
	set constFileHdlTvOut    "apint_arith.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
