...
$(ObjDir)/apint_arith_test.c_pre.c.tb.o : apint_arith_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) apint_arith_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/apint_arith.c_pre.c.tb.o : apint_arith.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) apint_arith.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
