...
void AESL_WRAP_apint_arith( char , signed short , signed int , signed long long , signed int *, signed short *, signed int *,  char *);


/* Global Variable Definitions and Initialization */
static  char aesl_internal__OC_str[11] = "result.dat";
static  char aesl_internal__OC_str1[2] = "w";
static  char aesl_internal__OC_str2[48] = "%d*%d=%d; %d+%d=%d; %d/%d=%d; %I64d mod %d=%d;\n";
...
printf("\n\{ BEGIN @main\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = call %%struct._iobuf* @fopen(i8* getelementptr inbounds ([11 x i8]* @aesl_internal_.str, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @aesl_internal_.str1, i64 0, i64 0)) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_8_count);
...
printf("\n = 0x%I64X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  call void @AESL_WRAP_apint_arith(i6 signext %%4, i12 signext %%6, i22 signext %%8, i33 %%10, i18* %%out1, i13* %%out2, i22* %%out3, i6* %%out4) nounwind, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_44_count);
  AESL_WRAP_apint_arith(llvm_cbe_tmp__3, llvm_cbe_tmp__5, llvm_cbe_tmp__7, llvm_cbe_tmp__9, (signed int *)(&llvm_cbe_out1), (signed short *)(&llvm_cbe_out2), (signed int *)(&llvm_cbe_out3), ( char *)(&llvm_cbe_out4));
if (AESL_DEBUG_TRACE) {
...
printf("\n = 0x%X\n", llvm_cbe_tmp__20);
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%1, i8* getelementptr inbounds ([48 x i8]* @aesl_internal_.str2, i64 0, i64 0), i32 %%11, i32 %%12, i32 %%14, i32 %%12, i32 %%11, i32 %%16, i32 %%17, i32 %%11, i32 %%19, i33 %%10, i32 %%11, i32 %%21) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_80_count);
...
llvm_cbe_tmp__27:
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = call i32 @fclose(%%struct._iobuf* %%1) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_90_count);
  fclose((l_struct_OC__iobuf *)llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__23);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%26 = call i32 @system(i8* getelementptr inbounds ([45 x i8]* @aesl_internal_.str3, i64 0, i64 0)) nounwind, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_91_count);
