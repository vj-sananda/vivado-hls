...
if {[file isfile apint_arith.autotvin.dat]} {
	file delete -force apint_arith.autotvin.dat
}

if {[file isfile apint_arith.autotvout.dat]} {
	file delete -force apint_arith.autotvout.dat
}
