...
#ifndef __loop_pipeline_macbkb__HH__
#define __loop_pipeline_macbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(loop_pipeline_macbkb) {
    ...
    SC_CTOR(loop_pipeline_macbkb):  simcore_mac_0_U ("simcore_mac_0_U") {
