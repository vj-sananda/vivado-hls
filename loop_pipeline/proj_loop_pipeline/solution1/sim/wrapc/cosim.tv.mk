...
$(ObjDir)/loop_pipeline_test.c_pre.c.tb.o : loop_pipeline_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) loop_pipeline_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/loop_pipeline.c_pre.c.tb.o : loop_pipeline.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) loop_pipeline.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
