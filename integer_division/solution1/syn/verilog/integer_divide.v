...
(* CORE_GENERATION_INFO="integer_divide,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z030sbv485-3,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=3.175000,HLS_SYN_LAT=35,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=4602,HLS_SYN_LUT=3492}" *)
...
integer_divide_sdbkb #(
    .ID( 1 ),
    .NUM_STAGE( 36 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
integer_divide_sdbkb_U1(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(dividend),
    .din1(divisor),
...
integer_divide_srcud #(
    .ID( 1 ),
    .NUM_STAGE( 36 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
integer_divide_srcud_U2(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(dividend),
    .din1(divisor),
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter35 == 1'b1))) begin
        q_ap_vld = 1'b1;
    end else begin
        q_ap_vld = 1'b0;
    end
...
assign q = grp_fu_52_p2;

assign rem_r = grp_fu_59_p2;
