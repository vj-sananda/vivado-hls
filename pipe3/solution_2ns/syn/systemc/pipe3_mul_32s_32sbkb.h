...
#ifndef __pipe3_mul_32s_32sbkb__HH__
#define __pipe3_mul_32s_32sbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(pipe3_mul_32s_32sbkb) {
    ...
    SC_CTOR(pipe3_mul_32s_32sbkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
