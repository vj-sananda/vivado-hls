...
void AESL_WRAP_add(signed int *, signed int *, signed int *);
...
printf("\n = 0x%X\n", 9u);
if (AESL_DEBUG_TRACE)
printf("\n  call void @AESL_WRAP_add(i32* %%1, i32* %%2, i32* %%result) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_122_count);
  AESL_WRAP_add((signed int *)llvm_cbe_tmp__1, (signed int *)llvm_cbe_tmp__2, (signed int *)(&llvm_cbe_result));
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
