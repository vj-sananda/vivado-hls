set C_TypeInfoList {{ 
"sort" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"a": [[], {"array": [ {"scalar": "int"}, [1000]]}] }, {"out": [[], {"array": [ {"scalar": "int"}, [1000]]}] }],[],""]
}}
set moduleName sort
...
set C_modelArgList {
	{ a int 32 regular {array 1000 { 2 2 } 1 1 }  }
	{ out_r int 32 regular {array 1000 { 0 3 } 0 1 }  }
}
...
set ArgLastReadFirstWriteLatency {
	sort {
		a {Type IO LastRead 3 FirstWrite 3}
		out_r {Type O LastRead -1 FirstWrite 3}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4002", "Max" : "2002002"}
	, {"Name" : "Interval", "Min" : "4003", "Max" : "2002003"}
]}
