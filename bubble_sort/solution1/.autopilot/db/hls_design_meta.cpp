...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("a_address1", 10, hls_out, 0, "ap_memory", "mem_address", 1),
	...
	Port_Property("out_r_address0", 10, hls_out, 1, "ap_memory", "mem_address", 1),
...
const char* HLS_Design_Meta::dut_name = "sort";
