...
`define AUTOTB_DUT      sort
`define AUTOTB_DUT_INST AESL_inst_sort
`define AUTOTB_TOP      apatb_sort_top
`define AUTOTB_LAT_RESULT_FILE "sort.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "sort.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_sort_top
...
`define AUTOTB_TVIN_a  "./c.sort.autotvin_a.dat"
`define AUTOTB_TVIN_out_r  "./c.sort.autotvin_out_r.dat"
`define AUTOTB_TVIN_a_out_wrapc  "./rtl.sort.autotvin_a.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "./rtl.sort.autotvin_out_r.dat"
`define AUTOTB_TVOUT_a  "./c.sort.autotvout_a.dat"
`define AUTOTB_TVOUT_out_r  "./c.sort.autotvout_out_r.dat"
`define AUTOTB_TVOUT_a_out_wrapc  "./impl_rtl.sort.autotvout_a.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "./impl_rtl.sort.autotvout_out_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 2002002;
parameter LENGTH_a = 1000;
parameter LENGTH_out_r = 1000;
...
wire    [9 : 0]    arrayout_r_address0, arrayout_r_address1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.sort.autotvout_a.dat", "r");
    fp2 = $fopen("./impl_rtl.sort.autotvout_a.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.sort.autotvout_a.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.sort.autotvout_a.dat\"!");
    else begin
        $display("Comparing rtl.sort.autotvout_a.dat with impl_rtl.sort.autotvout_a.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.sort.autotvout_out_r.dat", "r");
    fp2 = $fopen("./impl_rtl.sort.autotvout_out_r.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.sort.autotvout_out_r.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.sort.autotvout_out_r.dat\"!");
    else begin
        $display("Comparing rtl.sort.autotvout_out_r.dat with impl_rtl.sort.autotvout_out_r.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
