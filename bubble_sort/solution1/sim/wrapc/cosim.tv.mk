...
$(ObjDir)/test_sort.c_pre.c.tb.o : test_sort.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) test_sort.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/sort.c_pre.c.tb.o : sort.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) sort.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
