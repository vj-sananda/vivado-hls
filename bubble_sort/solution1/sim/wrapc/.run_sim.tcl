...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sort.autotvin.dat"
	set constFileTvOut       "sort.autotvout.dat"
	set constFileHdlTvIn     "sort.autohdltvin.dat"
	set constFileHdlTvOut    "sort.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
